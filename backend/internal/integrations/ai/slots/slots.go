...
// Parse extracts slot values from a single message (pure function).
...
// Merge returns a new Slots combining existing with new values.
...
// BuildSearchQuery combines user message with top preferences to bias FTS.
