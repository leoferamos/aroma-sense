...
const AdminProducts: React.FC = () => {
  ...
  const actions = (
    <div className="flex items-center gap-2">
      <Link
        to="/admin/dashboard"
        className="h-9 px-3 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-lg hover:bg-gray-50"
      >
        ← {t('nav.dashboard')}
      </Link>
      <Link
        to="/admin/products/new"
        className="h-9 px-3 py-1.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700"
      >
        + {t('addProduct')}
      </Link>
    </div>
